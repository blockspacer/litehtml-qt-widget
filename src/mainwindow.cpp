...
ui(new Ui::MainWindow)
{
  ...
  <div style='font: "Font Awesome 5 Free";background:pink;border-left:16px solid grey;width:30px;height:30px'>–”—text4\uf15c ?</div>
  ...
  //QString html2 = QString::fromUtf8(qPrintable(u8"F?llungRaupeStep—ã–≤–∞—ã–≤–∞text"));//tr("F?llungRaupeStep—ã–≤–∞—ã–≤–∞text");
